      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 flex items-center justify-between">
        <div className="flex items-center">
          <a href="#" className="text-xl font-bold">
            <span className="text-white inline-block relative after:absolute after:bg-accent after:h-1 after:w-0 after:-bottom-1 after:left-0 hover:after:w-full after:transition-all after:duration-300">Port<span className="text-accent">folio</span></span>
          </a>
        </div>
        ...
        >
          {mobileMenuOpen ? <X size={24} className="text-accent" /> : <Menu size={24} className="text-primary" />}
        </button>
      </div>
